...
/**
 * Provides a resource to render a diff of two drafts.
 *
 * This is modeled on https://www.drupal.org/project/drupal/issues/2884721.
 *
 * @RestResource(
 *   id = "corpus_diff",
 *   label = @Translation("Corpus Diff"),
 *   uri_paths = {
 *     "canonical" = "/corpus/diff"
 *   }
 * )
 */
class CorpusDiff extends ResourceBase {
  ...
  public function get() {
    ...
    $roles = $user->getRoles();
    if (!in_array('full_text_access', $roles)) {
